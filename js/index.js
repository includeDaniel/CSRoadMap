...
document.getElementById("Math").onclick = () => {
    if(counter1 % 2 == 0) {
        ...
        document.getElementById("Math").style.backgroundColor = "var(--darker-color)"
        ...
        if(counter2 % 2 != 0) {
            ...
            document.getElementById("Code").style.backgroundColor = "var(--ligther-color)"
        ...
        document.getElementById("Math").style.backgroundColor = "var(--ligther-color)"
...
document.getElementById("Code").onclick = () => {
    if(counter2 % 2 == 0) {
        ...
        document.getElementById("Code").style.backgroundColor = "var(--darker-color)"
...
document.getElementById("SubWebFront").onclick = () => {
    if(counter3 % 2 == 0) {
        ...
        document.getElementById("SubWebFront").style.backgroundColor = "var(--darker-color)"
        ...
        document.getElementById("SubWebFront").style.backgroundColor = "var(--ligther-color)"
        document.getElementById("SubWebFront").style.color = "var(--contrast-color)"
        counter3++
    }
}
